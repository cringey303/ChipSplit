...
- **deploy_button_clicked**: User clicked the 'Deploy Now' button on the homepage.
- **documentation_button_clicked**: User clicked the 'Documentation' button on the homepage.
